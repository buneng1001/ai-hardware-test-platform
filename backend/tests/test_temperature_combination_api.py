...
def test_temperature_combination_links_facts_in_one_window_and_repeats(tmp_path, monkeypatch):
    ...
    assert first_checks["video_frame_drop"]["anomaly_windows"] == [{"channel": 1, "start_s": 0.8, "end_s": 1.2}]
    assert first_checks["temperature_window_correlation"]["anomaly_windows"] == [{"start_s": 0.8, "end_s": 1.2}]
