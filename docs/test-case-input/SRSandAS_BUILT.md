...
FR-003：支持 `quick`、`standard`、`custom`。快速预设为 2 秒/1 路/640x360/15 FPS/MP4/CSV/50Hz；标准预设为 5 秒/4 路/1280x720/30 FPS/MP4/CSV/100Hz；预设随机种子为 20260822。

FR-004：自定义模式要求完整提供时长、视频、IMU 和随机种子。

FR-005：时长 2～300 秒；视频通道 1～4；分辨率 `640x360`、`1280x720`、`1920x1080`；FPS 15、24、25、30、60；容器 MP4/MKV；编码固定 H.264。
